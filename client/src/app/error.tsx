...
export default function Error({
  ...
  return (
    // Replaced <html> and <body> with a <div> wrapper to prevent hydration crashes
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 text-slate-900 antialiased">
      {/* Main Card Container */}
